import { ApolloClient, ApolloLink, InMemoryCache, Observable, createHttpLink, fromPromise } from '@apollo/client'
...
const getNewToken = async() => {
  try {
    ...
    const response = await connectionAPIPost<Omit<TokensType, 'refresh_token'>>(URL_GRAPHQL, JSON.stringify({
      query: REFRESH_TOKEN,
