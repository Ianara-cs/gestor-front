...
import ConnectionAPI, { connectionAPIGet, connectionAPIPost, MethodType } from "../functions/connection/connectionAPI"
...
export const useRequests = () => {
  ...
  const authRequest = async (body: unknown) => {
    ...
    await connectionAPIGet<UserType>(URL_USER).then((result) => {
      setUser(result);
